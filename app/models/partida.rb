...
class Partida < ActiveRecord::Base
  ...
  def armar_url_heroes_draft
    	url_heroes_draft = "http://heroesdraft.com/create.php"
	  	...
	  	request.set_form_data({ mapSelectType:"0",numBans:"1",posted:"newMatch", startType:"0", teamOne: self.encuentro.gamerinscritoa.etiqueta_llave, teamTwo: self.encuentro.gamerinscritob.etiqueta_llave, tournament: self.encuentro.ronda.torneo.titulo })
