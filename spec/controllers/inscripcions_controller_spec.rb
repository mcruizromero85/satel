...
describe InscripcionsController do
  ...
  let(:valid_attributes) { { "fecha_inscripcion" => "2014-03-23" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # InscripcionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all inscripcions as @inscripcions" do
      ...
      expect(assigns(:inscripcions)).to eq([inscripcion])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved inscripcion as @inscripcion" do
        ...
        post :create, {:inscripcion => { "fecha_inscripcion" => "invalid value" }}, valid_session
        expect(assigns(:inscripcion)).to be_a_new(Inscripcion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested inscripcion" do
        ...
        expect_any_instance_of(Inscripcion).to receive(:update).with({ "fecha_inscripcion" => "2014-03-23" })
        put :update, {:id => inscripcion.to_param, :inscripcion => { "fecha_inscripcion" => "2014-03-23" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the inscripcion as @inscripcion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Inscripcion.any_instance.stub(:save).and_return(false)
        put :update, {:id => inscripcion.to_param, :inscripcion => { "fecha_inscripcion" => "invalid value" }}, valid_session
        expect(assigns(:inscripcion)).to eq(inscripcion)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the inscripcions list" do
      inscripcion = Inscripcion.create! valid_attributes
      delete :destroy, {:id => inscripcion.to_param}, valid_session
      expect(response).to redirect_to(inscripcions_url)
    end
  end
