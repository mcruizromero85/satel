...
#
#Dado que un torneo ya culminó su fase de inscripciones, entonces al intentar inscribirse a dicho torneo, el sistema mostrará el mensaje “Las inscripciones ya cerraron para el torneo, volver”, la palabra volver linkeará a la portada.
#Dado que un Gamer ya se inscribió a un torneo, entonces al intentar inscribirse nuevamente, el sistema mostrará el mensaje “Ya estás inscrito al torneo, espera la fase de confirmación”.
