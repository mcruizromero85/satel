...
feature 'Ficha de torneo' do
  before :all do
    ...
    @torneo_inscrito = FactoryGirl.create(:torneo, vacantes: 16, cierre_inscripcion: Time.new + 1200, juego: Juego.find_by(nombre: "Hearthstone"))
    ...
    FactoryGirl.create(:inscripcion, gamer: @authentication.gamer, torneo: @torneo_checkin, estado: "Confirmado")
  end
  ...
  scenario 'Dado que el torneo está en estado: “Check-In” entonces debo visualizar el botón "Check-In"'  do
    autenticarse_como_gamer @authentication.gamer.correo
