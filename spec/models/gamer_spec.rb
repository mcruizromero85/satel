...
describe Gamer do
  ...
  it 'Para identificar si estoy inscrito en un torneo' do
    ...
    FactoryGirl.create(:inscripcion, gamer: gamer, torneo: torneo, estado: 'Confirmado')
  ...
  it 'Obtener contrincante actual' do
    ...
    4.times do | contador |
      ...
      FactoryGirl.create(:inscripcion, gamer: gamer, torneo: torneo, estado: 'Confirmado', etiqueta_llave: 'Mateo ' + (contador + 1).to_s)
    end
